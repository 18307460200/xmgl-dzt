...
<div id="group_f0d592de" title="功能权限" style="border-width:1px;" name="funcRight" showCloseButton="false">
<div id="tree_panel_34d06d9b" class="min-fit" style="width:100%;height:100%;">
<div style="width:100%;">
</div>
...
tree = new TreeBus("tree_panel_34d06d9b",{"resultAsTree":"true","showTreeIcon":"true","idField":"id","class":"mini-tree","textField":"name","ondrawnode":"onDrawNode","id":"catalogRightsTree","eventNo":"e_catalogrights_tree","inputs":"user_id:'$user_id$'","style":"height:92%;width:100%;","showLoading":"true","showCheckBox":"true","parentField":"pid","expandOnLoad":"0","autoCheckParent":"true"});
...
<div id="group_5c8a411e" title="数据权限" style="border-width:1px;" name="dataRight" showCloseButton="false">
<div id="tree_panel_d984f0dd" class="min-fit" style="width:100%;height:100%;">
<div style="width:100%;">
<div style="width:100%;">
<div id="toolbar_0d362787" style="padding:2px;border-top:0;border-left:0;border-right:0;" class="mini-toolbar">
<table style="width:100%;">
<tr>
<td id="group_d797e579" style="border-width:1px;" tagname="toolbar">
<div id="form_0b963cb5" style="margin-top:5px">
<div style="padding-left:11px;padding-bottom:5px;padding-right:11px;">
<input textField="item_name" class="mini-combobox" emptyText="请选择权限要素" id="combobox_b51de71f" allowInput="true" style="width:30%;float:right;" showNullItem="false" name="right_type" valueField="item_value" value="branch_data" onvaluechanged="dataTypeChanged" required="true"/>
</div>
<div tagName="javascript" style="display:none;">
var form = $.tkui["form_0b963cb5"];
if(!form){
require.async("form",function(Form){
form = new Form("form_0b963cb5",{"id":"form_0b963cb5","style":"margin-top:5px","formitem":[{"dataType":"select","format":"data_type","tagId":"combobox_b51de71f"}]});
$.tkui["form_0b963cb5"] = form;
form.loadViewConfig();
});
}
</div>
...
if(!tree){
require.async("tree",function(TreeBus){
tree = new TreeBus("tree_panel_d984f0dd",{"resultAsTree":"true","showTreeIcon":"true","idField":"id","class":"mini-tree","textField":"name","ondrawnode":"onDrawNode","id":"dataRightsTree","eventNo":"e_dataright_tree","style":"height:92%;width:100%;","inputs":"user_id:'$user_id$'","showLoading":"true","paramFunc":"getParam","showCheckBox":"true","expandOnLoad":"0","parentField":"pid","autoCheckParent":"true"});
