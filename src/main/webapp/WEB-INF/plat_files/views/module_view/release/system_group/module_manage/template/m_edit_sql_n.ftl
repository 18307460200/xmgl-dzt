...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;margin:2px;">
  ...
  <div region="west" title="SQL流程脚本" showheader="true"  expanded="false" bodystyle="padding-right:1px;overflow-y:hidden;" showspliticon="false"  width="350" >
    <TK:Form id="form1" eventNo="e_query_js" inputs="module_id:'$module_id$',event_id:'$event_id$'"  loadDataCallBackFunc="loadDataCallbackFunc">
    <TK:Hidden name="module_id">
                    ...
                    <TK:Hidden name="script_id" />
					<TK:Table>
            <TK:Group>
              <TK:CEditor label="" labelStyle="width:1px;" name="script_value" style="width:100%;height:480px;" id="script_value" />
            </TK:Group>
          </TK:Table>
        <TK:Table>
       <TK:Group>
