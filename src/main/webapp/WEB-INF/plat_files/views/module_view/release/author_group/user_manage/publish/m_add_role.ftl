...
<body id="bodyContent">
<div id="datarid_panel_0f49d07e" class="mini-fit" style="width:100%;height:100%;">
<div style="width:100%;">
<div style="width:100%;">
<div id="toolbar" style="padding:2px;border-top:0;border-left:0;border-right:0;" class="mini-toolbar">
<table style="width:100%;">
<tr>
<td id="group_e22b68ec" style="width:100%;" tagname="toolbar">
<a id="button_65926023" class="mini-button" plain="true" iconCls="icon-add">选择角色</a>
</td>
<td id="group_d68668f6" style="white-space:nowrap;" tagname="toolbar">
<input id="key" style="width:150px;" name="key" class="mini-textbox" emptyText="请输入名称"/>
<a id="button_f960c9d5" class="mini-button" iconCls="icon-redo">查询</a>
</td>
</tr>
</table>
</div>
...
<div id="fields_2fd833be" property="columns">
<div field="field_da18d610" id="field_da18d610" allowSort="true" headerAlign="center" type="checkcolumn">
序号
</div>
<div id="field_e0612ef1" field="role_no" allowSort="true" width="110" headerAlign="center">
角色英文名
</div>
<div id="field_1e870b04" field="name" allowSort="true" width="110" headerAlign="center">
角色名称
</div>
</div>
</div>
...
datagrid = new DataGridBus("datarid_panel_0f49d07e",{"showSortIcon":"false","borderStyle":"border:0","toolbar":[{"tagId":"button_65926023","function":"addRole"},{"tagId":"button_f960c9d5","function":"query"}],"idField":"id","allowUnselect":"false","showPager":"true","emptyText":"暂无数据","id":"datagrid1","multiSelect":"true","frozenStartColumn":"-1","style":"width:100%;height:100%;","allowAlternating":"true","isPage":"true","fields":[{"id":"field_da18d610","field":"field_da18d610","allowSort":"true","headerAlign":"center","type":"checkcolumn"},{"field":"role_no","id":"field_e0612ef1","allowSort":"true","headerAlign":"center","width":"110"},{"field":"name","id":"field_1e870b04","allowSort":"true","headerAlign":"center","width":"110"}],"allowResize":"false","onrowdblclick":"onRowDblClick","pageSize":"20","class":"mini-datagrid","eventNo":"e_query_role","allowSortColumn":"true","isMulPageSelect":"true","showEmptyText":"true","loadDataCallBackFunc":"selectDatagrid","showColumnsMenu":"true","frozenEndColumn":"-1"});
