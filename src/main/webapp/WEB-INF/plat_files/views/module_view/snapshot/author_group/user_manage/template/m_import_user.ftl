	...
	<TK:Form id="form1" style="width:80%;height:100%;margin-left:4%">
    	<TK:Table>
    		<TK:Group style="height:10px"></TK:Group>
             <tr><td><span style="margin-left:40px">导入模板：</span><a href="${ctxPath}/upload/tempFile/importUser.xlsx">点击下载导入模板</a></td></tr>
         	<TK:Group style="height:10px"></TK:Group>
            <TK:Group>
            	<TK:Upload label="导入用户信息："  name="file_data"  required="true" allowInput="false">
            ...
            <TK:Group>
            	...
            	<TK:Button displayName="确认导入" style="width:80px">
                	<TK:Property function="submit" eventNo="e_import_user"  isValid="true" isClose="true" />
                </TK:Button>
