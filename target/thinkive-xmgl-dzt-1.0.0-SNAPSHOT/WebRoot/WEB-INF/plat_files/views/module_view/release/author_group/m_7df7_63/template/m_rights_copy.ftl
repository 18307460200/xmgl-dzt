 <TK:Page>
 	<div style="height:370px">
	    <TK:Tree id="tree1" eventNo="e_tree_dept" style="height:80%" inputs="source_id:'$source_id$',id:'$dept_id$'" onDrawnode="onBeforeNodeSelect" >
	        <TK:Toolbar>
		 	...
		 	<TK:Group>
		 		<td align="center">
		 			<TK:Button displayName="确定" style="width:60px;margin-right:20px;" iconCls="icon-ok">    
                         <TK:Property function="submit" eventNo="e_add_rights_copy" inputs="source_id:'$source_id$'" paramFunc="getParam" isValid="true" isClose="true"/>  
                   </TK:Button>   
