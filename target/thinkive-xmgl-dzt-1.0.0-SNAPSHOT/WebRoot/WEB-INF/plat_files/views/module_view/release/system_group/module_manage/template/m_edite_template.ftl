...
<div id="layout1" class="mini-layout" style="width:100%;height:100%;">
  <div title="center" region="center" bodyStyle="overflow:hidden;" style="border:0;">
          <TK:Form id="form1" inputs="template_id:'$template_id$'" loadDataCallBackFunc="loadDataCallBackFunc" eventNo="e_query_templateinfo" >
            <TK:Hidden name="template_id" />
          ...
          <TK:Table>
			...
			<TK:Group>
				<TK:ComboBox label="生成文件编码：" name="file_encoding" required="true">
				  <TK:Property dataType="select" format="encode"/>
				</TK:ComboBox>
				<TK:ComboBox label="文件存储类型：" name="file_type" onvaluechanged="onEventTypeChanged" required="true" >
				  <TK:Property dataType="select" format="file_type"/>
				</TK:ComboBox>
			</TK:Group>
             <TK:Group>
                 <td>
                 <TK:Checkbox text="是否首页" name="is_index"  visible="false" value="0" trueValue="1" falseValue="0"/>
               </td>
                 <TK:ComboBox label="文件解析类型：" name="parse_type"  required="true" >
			...
			<TK:Group>
              <TK:Textbox label="模板地址：" name="template_url" visible="false" style="width:100%;" emptyText="请输入模板本地地址" required="true"/>
            </TK:Group>
            <TK:Group>
               <TK:CEditor label="模版内容：" name="content" style="width:100%;height:395px;" id="content" colspan="2" onvalidation="onValueCheck" visible="false"/>
            </TK:Group>              
          </TK:Table>
          <TK:Table>
       <TK:Group>
         <td colspan="2" align="center" style="padding-top:10px;">
           <TK:Button displayName="确定" style="width:60px;margin-right:20px;" iconCls="icon-ok">
             <TK:Property function="submit"  isAlert="true" alertMsg="是否提交？" eventNo="e_edite_template"  isValid="true"    isClose="true"/>
           </TK:Button> 
  ...
  <div region="east" title="事件列表" showheader="true"  expanded="false" bodystyle="padding-right:1px; overflow-y:hidden;" showspliticon="false"  width="350" >
      <TK:DataGrid  id="datagrid1" isCellCopy="true" pageSize="20" eventNo="e_query_eventbymoduleid" idField="event_id" inputs="module_id:''" style="width:100%;height:100%;">
            <TK:Toolbar> 
                            <TK:Group style="width:100%;">                     
                                  <TK:Button displayName="新增" iconCls="icon-add" plain="true">
                                        <TK:Property function="popWindow"  templateNo="m_add_event" title="新增模板事件"  width="600"  inputs="module_id:'$module_id$'" height="300"/>
                              </TK:Button>
