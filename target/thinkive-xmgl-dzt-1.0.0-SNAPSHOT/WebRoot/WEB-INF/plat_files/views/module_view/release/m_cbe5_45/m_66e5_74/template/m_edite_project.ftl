<TK:Page>
   <div style="height:100%;overflow:auto">
  	<TK:Form id="form1" style="margin-right:15px;" eventNo="e_get_one_project" inputs="id:'$id$'" loadDataCallBackFunc="loadDataCallBackFunc">
			<TK:Fieldset displayName="运营管理信息">
			 <TK:Table>
                ...
                <TK:Group>
               	...
               	<TK:Group>
                    <TK:Datepicker labelField="true"  	  labelStyle="width:150px;text-align:right;" tdStyle="width:80px;"   label="上线报告实际回笼时间：" format="yyyy-MM-dd"  name="top_thread_report_date"  />
                    <TK:Datepicker labelField="true"  	  labelStyle="width:150px;text-align:right;" tdStyle="width:80px;"   label="验收报告实际回笼时间：" format="yyyy-MM-dd"  name="acceptance_report_date"  />
		 	...
		 	<TK:Group>
		 		<td colspan="2" align="center">
		 			<TK:Button displayName="确定" style="width:60px;margin-right:20px;" iconCls="icon-ok">
		 				<TK:Property function="submit" eventNo="e_edite_project" isAlert="true"  inputs="" alertMsg="是否提交？" isValid="true" isClose="true"/>
		 			</TK:Button> 
