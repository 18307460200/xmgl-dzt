...
;(function ($, window, document, undefined) {
    ...
    Tree.prototype._subscribeEvents = function () {
        ...
        if (typeof (this._options.onMouseDown) === 'function') {
            this.$element.on('mousedown', this._options.onMouseDown);
        }
    };
    ...
    */
    ...
    Tree.prototype._buildStyle = function () {
        ...
        if (this._options.onhoverColor) {
            ...
            style += '.node-' + this._elementId + ':not(.node-disabled):hover{' +
                ...
                '}';
            $(this).parent().parent().attr("selectedNode",this._elementId);
        }
    ...
    Tree.prototype._template = {
        ...
        node: $('<li class="list-group-item" onmouseover="onmouseover()"></li>'),
